...
```
d in the next major release.
2026-04-17T20:56:12.398Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/schedule-drop-lambda/Code/Stage...
2026-04-17T20:56:12.812Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T20:56:12.820Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
                                    Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/progress-image-lambda/Code/Stage...
2026-04-17T20:56:13.123Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T20:56:13.124Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T20:56:13.125Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/drop-day-lambda/Code/Stage...
2026-04-17T20:56:13.549Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T20:56:13.549Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T20:56:13.550Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/public-share-lambda/Code/Stage...
2026-04-17T20:56:14.627Z [INFO]: 8:56:14 PM ✔ Backend synthesized in 5.42 seconds
2026-04-17T20:56:14.627Z [INFO]: 8:56:14 PM Running type checks...
2026-04-17T20:56:25.911Z [INFO]: 8:56:25 PM ✔ Type checks completed in 11.28 seconds
2026-04-17T20:56:26.100Z [INFO]: 
2026-04-17T20:56:26.101Z [INFO]: Notices:
...
2026-04-17T20:56:26.147Z [INFO]: 
2026-04-17T20:56:26.148Z [INFO]: [SyntaxError] TypeScript validation check failed.
                                 Resolution: Fix the syntax and type errors in your backend definition.
                                 Details: amplify/backend.ts:57:38 - error TS2339: Property 'addEnvironment' does not exist on type 'IFunction'.
                                 57 backend.sendInvites.resources.lambda.addEnvironment('PUBLIC_SHARE_URL', publicShareUrl.url);
                                 ~~~~~~~~~~~~~~
                                 amplify/functions/public-share/handler.ts:188:14 - error TS2322: Type '(event: APIGatewayProxyEventV2) => Promise<{ statusCode: number; headers: { 'Content-Type': string; 'Cache-Control'?: undefined; }; body: string; } | { statusCode: number; headers: { ...; }; body: string; }>' is not assignable to type 'LambdaFunctionURLHandler'.
                                 Type 'Promise<{ statusCode: number; headers: { 'Content-Type': string; 'Cache-Control'?: undefined; }; body: string; } | { statusCode: number; headers: { 'Content-Type': string; 'Cache-Control': string; }; body: string; }>' is not assignable to type 'void | Promise<LambdaFunctionURLResult<never>>'.
                                 Type 'Promise<{ statusCode: number; headers: { 'Content-Type': string; 'Cache-Control'?: undefined; }; body: string; } | { statusCode: number; headers: { 'Content-Type': string; 'Cache-Control': string; }; body: string; }>' is not assignable to type 'Promise<LambdaFunctionURLResult<never>>'.
                                 Type '{ statusCode: number; headers: { 'Content-Type': string; 'Cache-Control'?: undefined; }; body: string; } | { statusCode: number; headers: { 'Content-Type': string; 'Cache-Control': string; }; body: string; }' is not assignable to type 'LambdaFunctionURLResult<never>'.
                                 Type '{ statusCode: number; headers: { 'Content-Type': string; 'Cache-Control'?: undefined; }; body: string; }' is not assignable to type 'LambdaFunctionURLResult<never>'.
                                 Type '{ statusCode: number; headers: { 'Content-Type': string; 'Cache-Control'?: undefined; }; body: string; }' is not assignable to type 'APIGatewayProxyStructuredResultV2'.
                                 Types of property 'headers' are incompatible.
                                 Type '{ 'Content-Type': string; 'Cache-Control'?: undefined; }' is not assignable to type '{ [header: string]: string | number | boolean; }'.
                                 Property ''Cache-Control'' is incompatible with index signature.
                                 Type 'undefined' is not assignable to type 'string | number | boolean'.
                                 188 export const handler: LambdaFunctionURLHandler = async (event) => {
                                 ~~~~~~~
2026-04-17T20:56:26.148Z [WARNING]: ampx pipeline-deploy
...
2026-04-17T20:56:26.219Z [ERROR]: !!! Build failed
2026-04-17T20:56:26.219Z [ERROR]: !!! Error: Command failed with exit code 1
2026-04-17T20:56:26.219Z [INFO]: # Starting environment caching...
2026-04-17T20:56:26.219Z [INFO]: # Uploading environment cache artifact...
2026-04-17T20:56:26.360Z [INFO]: # Uploaded environment cache artifact
2026-04-17T20:56:26.360Z [INFO]: # Environment caching completed
...
1. **Engineer**: Fix two TypeScript errors blocking Amplify backend synth, then run `npm run build` locally until it passes, then commit and push.

Error 1 — amplify/backend.ts:57:
`backend.sendInvites.resources.lambda.addEnvironment('PUBLIC_SHARE_URL', publicShareUrl.url)` fails because `resources.lambda` is typed as `IFunction`, which has no `addEnvironment`. Cast to the concrete `Function` from aws-cdk-lib/aws-lambda: `(backend.sendInvites.resources.lambda as import('aws-cdk-lib/aws-lambda').Function).addEnvironment('PUBLIC_SHARE_URL', publicShareUrl.url)` (or import Function at top and cast). Do the same for any other similar addEnvironment calls in backend.ts.

Error 2 — amplify/functions/public-share/handler.ts:188:
The handler is typed `LambdaFunctionURLHandler` but returns objects where `headers` has an optional `'Cache-Control'?: undefined` — which isn't assignable to the index signature `{ [header: string]: string | number | boolean }`. Fix by ensuring every returned response object uses a consistently-typed headers record. Simplest fix: type the handler's returned headers as `Record<string, string>` explicitly, OR build each response so the two branches have identical header shapes (e.g., always include 'Cache-Control' with a concrete string, or always omit it — do not conditionally set it to undefined). You can also change the handler signature to return `Promise<APIGatewayProxyStructuredResultV2>` and keep `LambdaFunctionURLHandler` — but prefer the handler type from aws-lambda that matches Function URL invocation. Ensure no property is typed as `undefined`.

Do NOT disable pipeline-deploy, do NOT stub amplify_outputs.json, do NOT switch resource.ts secrets to process.env. After fixes, run `npm run build` and iterate until exit 0, then `git add -A && git commit -m "fix: backend.ts addEnvironment cast + public-share handler header types" && git push`.

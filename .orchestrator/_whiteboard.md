...
2026-04-17T18:17:47.920Z [INFO]: 6:17:47 PM Synthesizing backend...
2026-04-17T18:17:47.924Z [INFO]: 
2026-04-17T18:17:49.288Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/AmplifyBranchLinker/CustomResourceLambda/Code/Stage...
2026-04-17T18:17:49.670Z [WARNING]: ...74cd863e2013a38c268ecc440dd07bae694e4a2f9c51dd-building/index.js  961.6kb
                                    ⚡ Done in 73ms
2026-04-17T18:17:49.806Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/auth/AmplifySecretFetcherResourceProviderLambda/Code/Stage...
2026-04-17T18:17:50.121Z [WARNING]: ...80a1ff7b5c04b7a9eaea185efa7a47aaf735204e6dcf98-building/index.js  714.0kb
                                    ⚡ Done in 50ms
2026-04-17T18:17:50.170Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:50.170Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:50.172Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/send-invites-lambda/Code/Stage...
2026-04-17T18:17:50.673Z [WARNING]: Be careful when using @auth directives on a field in a root type. @auth directives on field definitions use the source object to perform authorization logic and the source will be an empty object for fields on root types. Static group authorization should perform as expected.
2026-04-17T18:17:50.879Z [WARNING]: WARNING: owners may reassign ownership for the following model(s) and role(s): Drop: [owner]. If this is not intentional, you may want to apply field-level authorization rules to these fields. To read more: https://docs.amplify.aws/cli/graphql/authorization-rules/#per-user--owner-based-data-access.
2026-04-17T18:17:50.932Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:50.933Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:50.934Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/schedule-drop-lambda/Code/Stage...
2026-04-17T18:17:51.317Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:51.322Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
                                    Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/progress-image-lambda/Code/Stage...
2026-04-17T18:17:51.610Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:51.610Z [WARNING]: [WARNING] aws-cdk-lib.aws_lambda.FunctionOptions#logRetention is deprecated.
                                    use `logGroup` instead
                                    This API will be removed in the next major release.
2026-04-17T18:17:51.611Z [WARNING]: Bundling asset amplify-d1u2km81dncoin-main-branch-30a4492368/function/drop-day-lambda/Code/Stage...
2026-04-17T18:17:52.840Z [INFO]: 6:17:52 PM ✔ Backend synthesized in 5.38 seconds
2026-04-17T18:17:52.841Z [INFO]: 6:17:52 PM Running type checks...
2026-04-17T18:18:03.451Z [INFO]: 6:18:03 PM ✔ Type checks completed in 10.61 seconds
2026-04-17T18:18:03.469Z [INFO]: 6:18:03 PM Building and publishing assets...
2026-04-17T18:18:04.126Z [INFO]: 
2026-04-17T18:18:04.127Z [INFO]: Notices:
2026-04-17T18:18:04.127Z [INFO]: 3127	Amplify Function is dropping support of Node 16 Lambda Functions
...
2026-04-17T18:18:04.127Z [INFO]: If you don't want to see a notice anymore, use npx ampx notices acknowledge <notice-id>
2026-04-17T18:18:04.175Z [INFO]: 
2026-04-17T18:18:04.176Z [INFO]: [BootstrapDetectionError] Unable to detect CDK bootstrap stack due to permission issues.
                                 ∟ Caused by: [ToolkitError] amplify-d1u2km81dncoin-main-branch-30a4492368: This CDK deployment requires bootstrap stack version '6', but during the confirmation via SSM parameter /cdk-bootstrap/hnb659fds/version the following error occurred: AccessDeniedException: User: arn:aws:sts::073653171576:assumed-role/AemiliaControlPlaneLambda-CodeBuildRole-1PJH7JZRIQRPI/AWSCodeBuild-3cf5ae15-efe8-4eb3-abaf-585aabdb18b1 is not authorized to perform: ssm:GetParameter on resource: arn:aws:ssm:us-east-1:073653171576:parameter/cdk-bootstrap/hnb659fds/version because no identity-based policy allows the ssm:GetParameter action
...
2026-04-17T18:18:04.176Z [WARNING]: ampx pipeline-deploy
...
2026-04-17T18:18:04.247Z [ERROR]: !!! Build failed
2026-04-17T18:18:04.248Z [ERROR]: !!! Error: Command failed with exit code 1
2026-04-17T18:18:04.248Z [INFO]: # Starting environment caching...
2026-04-17T18:18:04.248Z [INFO]: # Environment caching completed
...
1. **Installer**: Run `npm run build` locally and confirm it exits 0. Do NOT modify amplify.yml to skip pipeline-deploy, do NOT commit amplify_outputs.json, do NOT change resource.ts secrets. The deploy failure is a `BootstrapDetectionError` caused by the Amplify app's IAM service role missing `ssm:GetParameter` on `arn:aws:ssm:*:*:parameter/cdk-bootstrap/*` — this is an AWS Console / IAM fix the user must perform (attach a policy granting ssm:GetParameter on cdk-bootstrap params and the standard CDK bootstrap permissions to role AemiliaControlPlaneLambda-CodeBuildRole or the app's configured service role). After verifying the local build is clean, stage any incidental working-tree changes (like .orchestrator/_prompt.txt and build.json) and commit with message `Fix: local build verified clean; deploy blocked on IAM bootstrap permission (manual AWS Console fix: grant ssm:GetParameter on /cdk-bootstrap/* to Amplify service role)` then `git push`. Report clearly in your summary that no code change can fix this — the user must update IAM.
